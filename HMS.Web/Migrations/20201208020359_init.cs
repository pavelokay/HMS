    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelComplexes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                name: "HotelComplexImages",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    HotelComplexId = table.Column<int>(type: "int", nullable: false),
                    AltName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ImageFile = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_HotelComplexImages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HotelComplexImages_HotelComplexes_HotelComplexId",
                        column: x => x.HotelComplexId,
                        principalTable: "HotelComplexes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Hotels_HotelComplexes_HotelComplexId",
                        column: x => x.HotelComplexId,
                        principalTable: "HotelComplexes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DepartmentHotel", x => new { x.DepartmentsId, x.HotelsId });
                    table.ForeignKey(
                        name: "FK_DepartmentHotel_Departments_DepartmentsId",
                        column: x => x.DepartmentsId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DepartmentHotel_Hotels_HotelsId",
                        column: x => x.HotelsId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Decor = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Bathroom = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Bed = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Features = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    View = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTransaction", x => new { x.ServicesId, x.TransactionsId });
                    table.ForeignKey(
                        name: "FK_ServiceTransaction_Services_ServicesId",
                        column: x => x.ServicesId,
                        principalTable: "Services",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceTransaction_Transactions_TransactionsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DepartmentHotel_HotelsId",
                table: "DepartmentHotel",
                column: "HotelsId");

            migrationBuilder.CreateIndex(
                name: "IX_HotelComplexImages_HotelComplexId",
                table: "HotelComplexImages",
                column: "HotelComplexId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceTransaction_TransactionsId",
